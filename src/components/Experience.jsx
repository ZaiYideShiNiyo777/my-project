    ...
    <section id="experience" className="relative">
      <div className="section-container">
        <div ref={title.ref} style={revealStyle(title.visible)}>
          <h2 className="section-title">{uiTexts.experienceTitle}</h2>
          <p className="section-subtitle">{uiTexts.experienceSubtitle}</p>
        </div>

        <div className="relative max-w-3xl mx-auto">
          {/* 左侧渐变时间线 */}
          <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 via-accent-400 to-transparent" />
